...
namespace LogRotation
{
    ...
    // * when rotate happens, shift log files:
    ...
    internal class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            services.AddLogging(builder =>
            {
                ...
                builder.AddFile<RotatingFileLoggerProvider, RotatingFileLoggerOptions>(configure: o => o.RootPath = AppContext.BaseDirectory);
            });
